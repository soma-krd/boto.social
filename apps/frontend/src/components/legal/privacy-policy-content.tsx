  ...
  return (
    <div className="w-full max-w-none text-white">
      <div className="prose prose-invert prose-lg max-w-none 
        ...
        <h3>Surveys, events, marketing, and other activities</h3>
        ...
        <h3>Providing and securing our Services</h3>
        <ul>
        ...
        <h3>Improving our websites and applications</h3>
        <p>
        ...
        <p>
          ...
          <a href="mailto:hi@boto.social">privacy team</a>
          ...
          <a href="/terms-of-service">Boto terms of service</a>
        ...
        <p>
          ...
          <a href="mailto:hi@boto.social">here</a>
          ...
          <a href="https://security.google.com/settings/security/permissions" target="_blank" rel="noopener noreferrer">here</a>
          .
        </p>
        <p>
        ...
        <h3>Marketing emails, advertising and website browsing</h3>
        <p>
        ...
        <p>
          ...
          <a href="http://optout.networkadvertising.org/?c=1#!%2F" target="_blank" rel="noopener noreferrer">page</a>
          .
        </p>
        <p>
        ...
        <h3>Service Providers, Authorized Resellers, and Partners</h3>
        <p>
        ...
        <h3>Social Networks and Third-Party Services</h3>
        <p>
          ...
          <a href="https://www.google.com/policies/privacy" target="_blank" rel="noopener noreferrer">here</a>
          ) will apply to you.
        </p>

        <h3>Customer Organizations</h3>
        <p>
        ...
        <h3>Successor and Affiliated Entities</h3>
        <p>
        ...
        <h3>Law Enforcement, Government Agencies, and Professional Advisors</h3>
        <p>
        ...
        <h2>6. What international data transfers occur at Boto?</h2>
        <p>
        ...
        <h3>Legal bases for processing when Boto is a data controller</h3>
        ...
        <h3>Your rights when Boto is a data controller</h3>
        <p>
        ...
        <h3>Boto as a data processor</h3>
        <p>
        ...
        <h3>Your Rights</h3>
        <p>We have outlined certain rights in the section &ldquo;What are your privacy rights?&rdquo;</p>
        <p>Under the California Privacy Laws, you may have the following specific rights:</p>
        <ul>
          <li>The right to know about the personal information collected about you, which we have set out under &ldquo;here&rdquo;</li>
