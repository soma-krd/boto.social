  ...
  return (
    <div className="w-[100%] max-w-[1400px] overflow-y-auto">
      <div className="prose prose-lg max-w-none">
        <p>
          At Boto ("Company," "we," "us," or "our"), we are committed to protecting the privacy and security of our users' personal information. This Privacy Policy outlines how we collect, use, and safeguard the personal information collected on our website. By accessing or using our website, registering for the Website, and providing your personal information, you agree to the terms and conditions of this Privacy Policy.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">1. Our Services</h2>
        
        <h3 className="text-xl font-semibold mt-6 mb-3">Boto Services</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Social Networks</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Your Privacy Obligations</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Business Purposes</h3>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">2. What information do we collect?</h2>
        <p>We collect information about you as reasonably necessary for the following activities:</p>

        <h3 className="text-xl font-semibold mt-6 mb-3">Using our Services</h3>
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2">Content:</h4>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2">Logs, usage, and support data:</h4>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Surveys, events, marketing, and other activities</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Browsing our websites</h3>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Boto and our authorized service providers use cookies and similar tracking technologies, including web beacons, pixels, and software tokens, on our websites and services.</li>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">3. How do we use your information?</h2>
        <p>We use your information for the purposes described below:</p>

        <h3 className="text-xl font-semibold mt-6 mb-3">Providing and securing our Services</h3>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Communicating with you</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Improving our websites and applications</h3>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">4. What are your rights regarding the information about you?</h2>
        
        <h3 className="text-xl font-semibold mt-6 mb-3">Services information</h3>
        <p>
        ...
        <p>
          If you have requests that cannot be carried out by logging in to your account, such as accessing additional information or deleting information about you, for the Boto services, please email our{' '}
          <a href="mailto:hi@boto.social" className="text-blue-600 hover:text-blue-800 underline">
            privacy team
          </a>
          ...
          <a href="https://boto.social/terms-of-service" className="text-blue-600 hover:text-blue-800 underline">
            Boto terms of service
          </a>
          , or other agreement in place between you (or your organization) and Boto (collectively, the "Terms of Service").
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://security.google.com/settings/security/permissions" className="text-blue-600 hover:text-blue-800 underline">
            here
          </a>
          .
        </p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Marketing emails, advertising and website browsing</h3>
        <p>
        ...
        <p>
          ...
          <a href="http://optout.networkadvertising.org/?c=1#!%2F" className="text-blue-600 hover:text-blue-800 underline">
            page
          </a>
          .
        </p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Who has access to your information?</h2>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Authorized Contractors</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Service Providers, Authorized Resellers, and Partners</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Social Networks and Third-Party Services</h3>
        <p>
          ...
          <a href="https://www.google.com/policies/privacy" className="text-blue-600 hover:text-blue-800 underline">
            here
          </a>
          ) will apply to you.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-3">Customer Organizations</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Successor and Affiliated Entities</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Law Enforcement, Government Agencies, and Professional Advisors</h3>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">6. What international data transfers occur at Boto?</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">7. How do we safeguard your information?</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">8. How long do we retain your information?</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">9. Boto's roles under the GDPR and UK data protection laws</h2>
        <p>
          Depending on the situation and the type of data involved, Boto may act as a data controller or a data processor.
        </p>

        <h3 className="text-xl font-semibold mt-6 mb-3">Boto as a data controller</h3>
        <p>Boto may act as a data controller when we are:</p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Legal bases for processing when Boto is a data controller</h3>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Your rights when Boto is a data controller</h3>
        <p>
          Where Boto is acting as a data controller, we have outlined certain rights in the "What are your privacy rights?" section.
        </p>
        <p>In addition, you may have the following rights:</p>
        <ul className="list-disc pl-6 mb-4">
          <li>Right to object to processing: You may request that Boto stop processing information about you (for example, stop sending you marketing communications).</li>
          ...
          <li>Right to data portability: You may request that we provide you with information Boto has about you in a structured, machine-readable, and commonly used format or transfer this information to another data controller.</li>
        </ul>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3">Boto as a data processor</h3>
        <p>
        ...
        <p>
          As a data controller, you have certain obligations under the GDPR, including managing Content on the Services. As a data processor, Boto will only access and process Content to provide you with the Services by your instructions (which you provide through the Services), the Terms of Service, the Social Networks' terms, and applicable laws. As part of delivering the Services, we may process Content to improve further the Services, such as enhancing usability and developing new features.
        </p>
        <p>
          As a data controller, suppose you require Boto to agree to data protection requirements under Article 28, GDPR, or UK data protection laws. In that case, Boto makes available a data processing addendum that meets these requirements.
        </p>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">10. Your California Privacy Rights</h2>
        <p>
          Suppose you are a consumer as defined in the California Consumer Privacy Act (CCPA) and as amended by the California Privacy Rights Act (CPRA) (collectively, "California Privacy Laws'). In that case, the following provisions apply to you. Definitions of terms are set out in the California Privacy Laws.
        </p>
