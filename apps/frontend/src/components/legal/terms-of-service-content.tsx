...
export function TermsOfServiceContent() {
  return (
    <div className="w-full max-w-none text-white/80">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">1. Newsletter Subscription</h2>
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">2. Payment</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">3. Use of Cookies</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">5. Disclaimer</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">7. Changes to the Terms of Service</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">8. Indemnification</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">9. Governing Law and Jurisdiction</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">10. Entire Agreement</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">11. Severability</h2>
      <p className="leading-relaxed mb-4">
      ...
      <h2 className="text-2xl font-bold text-white mt-12 mb-6">12. Waiver</h2>
      <p className="leading-relaxed mb-4">
      ...
      <p className="leading-relaxed mb-4">
        ...
        <a href="mailto:hi@boto.social" className="text-violet-400 hover:text-violet-300 underline transition-colors">hi@boto.social</a>
      </p>

      <h2 className="text-2xl font-bold text-white mt-12 mb-6">14. Third Party Terms</h2>
      <p className="leading-relaxed mb-4">
