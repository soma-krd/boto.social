...
import { PickPlatforms } from '@boto/frontend/components/launches/helpers/pick.platform.component';
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          'webhooks_are_a_way_to_get_notified_when_something_happens_in_boto_via_an_http_request',
        ...
        body: JSON.stringify([
          {
            ...
            integration: {
              ...
              picture: 'https://uploads.boto.social/F6LSCD8wrrQ.jpeg',
              type: 'social',
            },
          },
          {
