        ...
        <div className="text-center mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {targetAudience.map((item) => (
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-600/20 to-pink-600/20 flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform">
                  <Image
                    src={item.icon}
                    alt={item.title}
                    width={32}
