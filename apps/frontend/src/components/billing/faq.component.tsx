  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_boto',
              'Am I going to be charged by Boto?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_boto_will_hold',
              'To confirm credit card information Boto will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      ...
      description: t(
        ...
        `${
          ...
          isGeneral ? 'Boto' : 'Gitroom'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/gitroomhq/boto-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
