  ...
  const register = async () => {
    ...
    try {
      const response = await fetch('/integrations/moltbook/register', {
        ...
        body: JSON.stringify({
          name: agentName.trim(),
          description: agentDescription.trim() || 'Boto social media scheduler',
        }),
      });
        ...
        <>
          ...
          <div className="w-full space-y-[12px]">
            <Input
              ...
              placeholder={t('moltbook_placeholder_name', 'MyBotoAgent')}
            />
            <Input
              ...
              placeholder={t('moltbook_placeholder_description', 'Social media scheduler')}
            />
